...
for (let i = 0; i < scores.length; i++) {
    ...
    if (scores[i].score < 60 ) scoreToPrint = 'F';
    else if (scores[i].score < 70 ) scoreToPrint = 'D';
    else if (scores[i].score < 80 ) scoreToPrint = 'C';
    else if (scores[i].score < 90 ) scoreToPrint = 'B';
    else if (scores[i].score < 100 ) scoreToPrint = 'A';

    console.log(scoreToPrint);
}
...
for (let i = 0; i < NOVIEmployees.length; i++) {
    ...
    NOVIEmployees[i].email = email.toLocaleLowerCase();
    console.log(NOVIEmployees[i]);
}
